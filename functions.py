...
def write_letter(name, job_title, sender_name):
    title_name = full_title(name, job_title)
    print(f"Dear {title_name}, I think you are amazing! Sincerely, {sender_name}")
